...
describe('test my mostProfitableDay function' , function(){
        it("it should return 'Thursday' when called with 'salesData' " , function(){
           assert.equal(mostProfitableDay(salesData),'Thursday'), "this should not be true"});
    
           it("it should return 'Wednesday' when called with 'salesData2' " , function(){
            assert.equal(mostProfitableDay(salesData2),'Wednesday'), "this should not be true"});
